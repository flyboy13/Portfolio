...
const String me = "$basePath$mePath/me.jpg";
const String logo = "$basePath$mePath/logo.svg";
const String mess = "$basePath$mePath/mess.svg";
const String message = "$basePath$mePath/message.svg";
const String earth = "$basePath$mePath/earth.svg";
